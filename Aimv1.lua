...
local StatusLabel = Instance.new("TextLabel") -- Hiển thị trạng thái
...
-- Nút X (Hiển thị và ẩn bảng điều khiển)
...
StatusLabel.Position = UDim2.new(0.85, 0, 0.07, 0)
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    if Locked then
        ToggleButton.Text = "ON"
        ToggleButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
        StatusLabel.Text = "Target Lock: ON"
    else
        ToggleButton.Text = "OFF"
        ToggleButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
        CurrentTarget = nil -- Hủy mục tiêu khi tắt CamLock
        StatusLabel.Text = "Target Lock: OFF"
    end
end)
